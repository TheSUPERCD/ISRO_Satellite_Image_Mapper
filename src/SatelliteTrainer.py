...
x_dataset = np.load('..\\Compressed_Dataset\\BareilyoutputMerged.npz')
xtrain = x_dataset['arr_0']
y_dataset = np.load('..\\Compressed_Dataset\\WaterMask.npz')
ytrain = tf.expand_dims(y_dataset['arr_0'], axis = -1)
...
# model.summary()
model.fit(xtrain,ytrain,epochs=num_epoch)
